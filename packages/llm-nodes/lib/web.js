...
class UibWeb {
    ...
    _webSetup() {
        ...
        this.app.use( urlJoin(uib.feModuleName), this.uibRouter )
    } // --- End of webSetup() --- //
    ...
    dumpAdminRoutes(print = true) {
        ...
        if (print) {
            ...
            console.log(`>> Admin uib Routes ${adminRoot}${this.uib.feModuleName}/* >>`)
            console.table(routes.admin)

            console.log(`>> Admin v3 Routes ${adminRoot}${this.uib.feModuleName}/admin >>`)
            console.table(routes.v3)

            console.log(`>> Admin v2 Routes ${adminRoot}${this.uib.feModuleName}/ >>`)
