export default {
    ...
    inject: {
        ...
        errors: {
            ...
            'invalid-jsonata':
                '__prop__: invalid property expression: __error__',
    ...
    function: {
        ...
        error: {
            ...
            inputListener:
                "Cannot add listener to 'input' event within Function",
            'non-message-returned':
                'Function tried to send a message of type __type__',
    ...
    mqtt: {
        ...
        state: {
            ...
            'broker-disconnected':
                'Broker __broker__ disconnected client: __reasonCode__ __reasonString__',
        },
        retain: 'Retain',
        output: {
            buffer: 'a Buffer',
        ...
        errors: {
            ...
            'invalid-action-alreadyconnected':
                'Disconnect from broker before connecting',
    ...
    httpin: {
        ...
        errors: {
            'not-created':
                'Cannot create http-in node when httpNodeRoot set to false',
    ...
    websocket: {
        ...
        errors: {
            ...
            'duplicate-path':
                'Cannot have two WebSocket listeners on the same path: __path__',
    ...
    tcpin: {
        ...
        errors: {
            ...
            'cannot-listen':
                'unable to listen on port __port__, error: __error__',
    ...
    udp: {
        ...
        status: {
            ...
            'mc-ready':
                'udp multicast ready: __iface__:__outport__ -> __host__:__port__',
    ...
    change: {
        ...
        errors: {
            ...
            'invalid-expr': 'Invalid JSONata expression: __error__',
            'no-override':
                'Cannot set property of non-object type: __property__',
    ...
    json: {
        errors: {
            ...
            'schema-error-compile':
                'JSON Schema error: failed to compile schema',
        },
        label: {
    ...
    file: {
        ...
        errors: {
            ...
            invaliddelete:
                'Warning: Invalid delete. Please use specific delete option in config dialog.',
    ...
    join: {
        ...
        seconds: 'seconds',
        complete:
            'After a message with the <code>msg.complete</code> property set',
