export default {
    ...
    notification: {
        ...
        warnings: {
            ...
            'safe-mode':
                '<p>Flows stopped in safe mode.</p><p>You can modify your flows and deploy the changes to restart.</p>',
            restartRequired:
                'Node-RED must be restarted to enable upgraded modules',
            credentials_load_failed:
                "<p>Flows stopped as the credentials could not be decrypted.</p><p>The flow credential file is encrypted, but the project's encryption key is missing or invalid.</p>",
            credentials_load_failed_reset:
                "<p>Credentials could not be decrypted</p><p>The flow credential file is encrypted, but the project's encryption key is missing or invalid.</p><p>The flow credential file will be reset on the next deployment. Any existing flow credentials will be cleared.</p>",
            missing_flow_file:
                '<p>Project flow file not found.</p><p>The project is not configured with a flow file.</p>',
            missing_package_file:
                '<p>Project package file not found.</p><p>The project is missing a package.json file.</p>',
            project_empty:
                '<p>The project is empty.</p><p>Do you want to create a default set of project files?<br/>Otherwise, you will have to manually add files to the project outside of the editor.</p>',
            project_not_found: "<p>Project '__project__' not found.</p>",
            git_merge_conflict:
                '<p>Automatic merging of changes failed.</p><p>Fix the unmerged conflicts then commit the results.</p>',
        },
        error: '<strong>Error</strong>: __message__',
        errors: {
            lostConnection: 'Lost connection to server, reconnecting...',
            lostConnectionReconnect:
                'Lost connection to server, reconnecting in __time__s.',
            lostConnectionTry: 'Try now',
            cannotAddSubflowToItself: 'Cannot add subflow to itself',
            cannotAddCircularReference:
                'Cannot add subflow - circular reference detected',
            unsupportedVersion:
                '<p>Using an unsupported version of Node.js</p><p>You should upgrade to the latest Node.js LTS release</p>',
            failedToAppendNode:
                "<p>Failed to load '__module__'</p><p>__error__</p>",
        },
        project: {
    ...
    clipboard: {
        ...
        recoveredNodesInfo:
            'The nodes on this flow were missing a valid flow id when they were imported. They have been added to this flow so you can either restore or delete them.',
        recoveredNodesNotification:
            "<p>Imported nodes without a valid flow id</p><p>They have been added to a new flow called '__flowName__'.</p>",
        export: {
        ...
        import: {
            ...
            errors: {
                ...
                itemNotObject:
                    'Input not a valid flow - item __index__ not a node object',
                missingId:
                    "Input not a valid flow - item __index__ missing 'id' property",
                missingType:
                    "Input not a valid flow - item __index__ missing 'type' property",
            },
            conflictNotification1:
    ...
    deploy: {
        ...
        confirm: {
            ...
            conflictChecking:
                'Checking to see if the changes can be merged automatically',
            conflictAutoMerge:
                'The changes include no conflicts and can be merged automatically.',
            conflictManualMerge:
                'The changes include conflicts that must be resolved before they can be deployed.',
    ...
    diff: {
        ...
        conflictHeader:
            '<span>__resolved__</span> of <span>__unresolved__</span> conflicts resolved',
    ...
    subflow: {
        ...
        subflowInstances:
            'There is __count__ instance of this subflow template',
        subflowInstances_plural:
            'There are __count__ instances of this subflow template',
        ...
        errors: {
            noNodesSelected:
                '<strong>Cannot create subflow</strong>: no nodes selected',
            acrossMultipleGroups:
                'Cannot create subflow across multiple groups',
            multipleInputsToSelection:
                '<strong>Cannot create subflow</strong>: multiple inputs to selection',
        },
    },
    group: {
        editGroup: 'Edit group: __name__',
        errors: {
            cannotCreateDiffGroups:
                'Cannot create group using nodes from different groups',
    ...
    editor: {
        ...
        errors: {
            scopeChange:
                'Changing the scope will make it unavailable to nodes in other flows that use it',
    ...
    library: {
        ...
        dialogSaveOverwrite:
            'A __libraryType__ called __libraryName__ already exists. Overwrite?',
    ...
    palette: {
        ...
        event: {
            ...
            nodeUpgraded:
                'Node module __module__ upgraded to version __version__',
            unknownNodeRegistered:
                'Error loading node: <ul><li>__type__<br>__error__</li></ul>',
        },
        editor: {
            ...
            conflict: 'conflict',
            conflictTip:
                '<p>This module cannot be installed as it includes a<br/>node type that has already been installed</p><p>Conflicts with <code>__module__</code></p>',
            ...
            errors: {
                catalogLoadFailed:
                    '<p>Failed to load node catalogue.</p><p>Check the browser console for more information</p>',
                installFailed:
                    '<p>Failed to install: __module__</p><p>__message__</p><p>Check the log for more information</p>',
                removeFailed:
                    '<p>Failed to remove: __module__</p><p>__message__</p><p>Check the log for more information</p>',
                updateFailed:
                    '<p>Failed to update: __module__</p><p>__message__</p><p>Check the log for more information</p>',
                enableFailed:
                    '<p>Failed to enable: __module__</p><p>__message__</p><p>Check the log for more information</p>',
                disableFailed:
                    '<p>Failed to disable: __module__</p><p>__message__</p><p>Check the log for more information</p>',
            },
            confirm: {
                install: {
    ...
    sidebar: {
        ...
        project: {
            ...
            projectSettings: {
                ...
                deleteConfirm:
                    "Are you sure you want to delete the local branch '__name__'? This cannot be undone.",
                unmergedConfirm:
                    "The local branch '__name__' has unmerged changes that will be lost. Are you sure you want to delete it?",
                ...
                deleteRemoteConfrim:
                    "Are you sure you want to delete the remote '__name__'?",
            ...
            userSettings: {
                ...
                workflowManualTip:
                    "All changes must be manually committed under the 'history' sidebar",
                workflowAuto: 'Automatic',
                workflowAutoTip:
                    'Changes are committed automatically with every deploy',
                sshKeys: 'SSH Keys',
                sshKeysTip:
                ...
                deleteConfirm:
                    'Are you sure you want to delete the SSH key __name__? This cannot be undone.',
            },
            versionControl: {
                ...
                upstream: 'upstream',
                localOverwrite:
                    'You have local changes that would be overwritten by changing the branch. You must either commit or undo those changes first.',
                ...
                trackedUpstreamBranch:
                    'The created branch will be set as the tracked upstream branch.',
                selectUpstreamBranch:
                    'The branch will be created. Select below to set it as the tracked upstream branch.',
                pushFailed:
                    'Push failed as the remote has more recent commits. Pull and merge first, then push again.',
                push: 'push',
                pull: 'pull',
                unablePull:
                    '<p>Unable to pull remote changes; your unstaged local changes would be overwritten.</p><p>Commit your changes and try again.</p>',
                showUnstagedChanges: 'Show unstaged changes',
                connectionFailed: 'Could not connect to remote repository: ',
                pullUnrelatedHistory:
                    '<p>The remote has an unrelated history of commits.</p><p>Are you sure you want to pull the changes into your local repository?</p>',
                ...
                statusUnmergedChanged:
                    'Your repository has unmerged changes. You need to fix the conflicts and commit the result.',
                repositoryUpToDate: 'Your repository is up to date.',
                commitsAhead:
                    'Your repository is __count__ commit ahead of the remote. You can push this commit now.',
                commitsAhead_plural:
                    'Your repository is __count__ commits ahead of the remote. You can push these commits now.',
                commitsBehind:
                    'Your repository is __count__ commit behind of the remote. You can pull this commit now.',
                commitsBehind_plural:
                    'Your repository is __count__ commits behind of the remote. You can pull these commits now.',
                commitsAheadAndBehind1:
                    'Your repository is __count__ commit behind and ',
                commitsAheadAndBehind1_plural:
                    'Your repository is __count__ commits behind and ',
                commitsAheadAndBehind2:
                    '__count__ commit ahead of the remote. ',
                commitsAheadAndBehind2_plural:
                    '__count__ commits ahead of the remote. ',
                commitsAheadAndBehind3:
                    'You must pull the remote commit down before pushing.',
                commitsAheadAndBehind3_plural:
                    'You must pull the remote commits down before pushing.',
    ...
    projects: {
        ...
        'require-clean': {
            confirm:
                '<p>You have undeployed changes that will be lost.</p><p>Do you want to continue?</p>',
        },
        'send-req': {
            ...
            'host-key-verify-failed':
                '<p>Host key verification failed.</p><p>The repository host key could not be verified. Please update your <code>known_hosts</code> file and try again.</p>',
        },
        'create-branch-list': {
        ...
        'create-default-file-set': {
            'no-active':
                'Cannot create default file set without an active project',
    ...
    validator: {
        errors: {
            ...
            'validation-error':
                '__prop__: validation error: __node__, __id__: __error__',
        },
    },
    contextMenu: {
