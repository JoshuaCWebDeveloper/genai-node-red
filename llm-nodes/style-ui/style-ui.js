...
const mod = {
    ...
    nodeName: 'style-ui', // Note that 'uib-update' will be replaced with actual node-name. Do not forget to also add to package.json
}
...
function nodeInstance(config) {
    ...
    this.slotContentSource = config.slotContent ?? ''
    this.slotContentSourceType = 'str'
